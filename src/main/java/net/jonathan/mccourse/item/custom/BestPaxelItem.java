...
public class BestPaxelItem extends SwordItem {
    public BestPaxelItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
