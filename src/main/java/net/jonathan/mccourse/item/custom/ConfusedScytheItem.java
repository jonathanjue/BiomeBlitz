...
public class ConfusedScytheItem extends SwordItem {
    public ConfusedScytheItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public boolean onLeftClickEntity(ItemStack stack, Player player, Entity entity) {
        if (entity instanceof LivingEntity livingEntity) {
            ...
            livingEntity.addEffect(new MobEffectInstance(MobEffects.GLOWING, 9999999, 10), player);
            //vingEntity.addEffect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 9999999, 255), player);
