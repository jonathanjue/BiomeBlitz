...
public class PoisonAxeItem extends SwordItem {
    public PoisonAxeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
...
//            livingEntity.addEffect(new MobEffectInstance(MobEffects.POISON, 9999999, 3), player);
              livingEntity.addEffect(new MobEffectInstance(MobEffects.POISON, 9999999, 5), player);
        }
