...
import net.jonathan.mccourse.item.ModArmorMaterials;
...
//                    .put(ModArmorMaterials.ALEXANDRITE, new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 4))
//                    .put(ModArmorMaterials.ALEXANDRITE, new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 200, 4))
                    .build();
