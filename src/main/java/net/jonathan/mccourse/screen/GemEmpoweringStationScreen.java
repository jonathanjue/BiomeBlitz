package net.jonathan.mccourse.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import net.jonathan.mccourse.MCCourseMod;
import net.jonathan.mccourse.screen.renderer.EnergyDisplayTooltipArea;
import net.jonathan.mccourse.screen.renderer.FluidTankRenderer;
import net.jonathan.mccourse.util.MouseUtil;
